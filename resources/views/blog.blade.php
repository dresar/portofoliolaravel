@extends('components.layouts.app', ['title' => 'Blog'])
                ...
                <article class="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition">
                    ...
                    <div class="p-6">
                        ...
                        <h2 class="text-xl font-bold mt-2 mb-3 text-gray-900 dark:text-white">
                            <a href="/blog/{{ $post->slug }}" class="hover:text-indigo-600 dark:hover:text-indigo-400 transition">
                                {{ $post->title }}
                            </a>
                        </h2>
                        @if($post->excerpt)
                        ...
                        @endif
                        <a href="/blog/{{ $post->slug }}" class="text-indigo-600 dark:text-indigo-400 hover:underline font-semibold inline-flex items-center">
                            Read More 
