@extends('components.layouts.app', ['title' => 'Home'])
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <p class="text-lg mb-8 text-gray-200">
                        ...
                        Spesialisasi dalam Laravel dan teknologi web terdepan.
                    </p>
                    <div class="flex flex-wrap gap-4">
                        <a href="/portfolio" class="bg-white text-indigo-600 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition">
                            View Portfolio
                        </a>
                        <a href="/contact" class="bg-transparent border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-indigo-600 transition">
                            Get In Touch
                        </a>
                    </div>
                </div>
    ...
    <section class="py-20 bg-white dark:bg-gray-900">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mt-12">
                <a href="/portfolio" class="bg-indigo-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-indigo-700 transition inline-block">
                    View All Projects
                </a>
            </div>
        </div>
